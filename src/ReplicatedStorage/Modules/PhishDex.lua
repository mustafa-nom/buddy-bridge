...
PhishDex.Species = {
	...
	{
		id = "RumorRay",
		displayName = "Rumor Ray",
		realPatternName = "Unverified viral claim",
		rarity = "Uncommon",
		description = "Glides fast through group chats. Looks convincing until you ask where the proof came from.",
		realWorldInfo = "Rumors often spread through urgent shares, screenshots, and claims without a primary source.",
		redFlags = {
			"No original source",
			"Pushes you to share quickly",
			"Uses a screenshot as proof instead of a real link",
		},
		defenseStrategy = "Pause before sharing. Look for the original source or a trusted fact-check.",
		catchesToUnlock = 3,
		isLegit = false,
	},
	{
		id = "ModImposter",
		displayName = "Mod Imposter",
		realPatternName = "Fake admin or moderator",
		rarity = "Rare",
		description = "Wears a fake badge and asks for proof that real staff would never need.",
		realWorldInfo = "Real moderators do not ask for passwords, backup codes, private keys, or off-platform verification.",
		redFlags = {
			"Claims moderator power from an unofficial address",
			"Asks for login or backup codes",
			"Threatens bans to rush compliance",
		},
		defenseStrategy = "Use the platform's official report tools and never verify through a random link.",
		catchesToUnlock = 3,
		isLegit = false,
	},
	{
		id = "HallucinationJelly",
		displayName = "Hallucination Jelly",
		realPatternName = "AI misinformation",
		rarity = "Rare",
		description = "Transparent and wobbly. Sounds smart, but the facts drift if you poke them.",
		realWorldInfo = "AI tools can invent sources, policies, quotes, and instructions. Confident wording is not proof.",
		redFlags = {
			"Mentions sources you cannot verify",
			"Claims a policy changed with no official link",
			"Uses confident wording without evidence",
		},
		defenseStrategy = "Verify AI answers against official sources before acting or sharing.",
		catchesToUnlock = 3,
		isLegit = false,
	},
	...
	{
		id = "KindnessKoi",
		displayName = "Kindness Koi",
		realPatternName = "Positive digital citizenship",
		rarity = "Uncommon",
		description = "Bright, calm, and helpful. Makes online spaces safer without making drama bigger.",
		realWorldInfo = "Good digital citizenship includes kindness, clear boundaries, reporting harm, and asking before sharing private info.",
		redFlags = {},
		defenseStrategy = "Keep it. Helpful, calm, non-invasive messages are worth encouraging.",
		catchesToUnlock = 3,
		isLegit = true,
	},
}
