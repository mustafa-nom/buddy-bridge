--!nonstrict
-- Vendored from boatbomber/WindShake demo:
-- https://github.com/boatbomber/WindShake/blob/main/demo/client/WindController/WindLines.lua
-- Pure visual wind streaks via Trail. NO parts move or shake — this is
-- the wind effect without the foliage shake module.
